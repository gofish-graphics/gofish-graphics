...
const createPalette = (
  color: string,
  white: string = baseWhite,
  black: string = baseBlack
) => {
...
export const color6_20250320 = [
  (color as unknown as Record<string, string[]>)[color10Order[0]][5],
  (color as unknown as Record<string, string[]>)[color10Order[1]][4],
  (color as unknown as Record<string, string[]>)[color10Order[4]][5],
  color.red[4],
  (color as unknown as Record<string, string[]>)[color10Order[3]][4],
  (color as unknown as Record<string, string[]>)[color10Order[2]][4],
];
...
// Tailwind CSS Color Palette (OKLCH format)
export const tailwindColorsVivid = {
  red: {
  ...
  stone: {
    ...
    950: "oklch(15.2% 0.004 106.418)",
  },
};

// Import OKLCH utilities and create color variants
import { createColorVariant } from "./oklch";

// Generate color variants with different chroma levels
export const tailwindColorsMuted = createColorVariant(
  tailwindColorsVivid,
  (chroma) => chroma * 0.5,
  (luminance) => luminance
);
...
export const tailwindColors = createColorVariant(
  tailwindColorsVivid,
  (chroma) => chroma * 0.77,
  (luminance) => luminance,
  0.9
...
export const color6 = [
  ...
  // "#eb84ba",
  "#d45e83",
  // tailwindColors.sky[600 + offset],
  // tailwindColors.yellow[400 + offset],
  // tailwindColors.purple[700 + offset],
  // tailwindColors.green[600 + offset],
  // tailwindColors.orange[500 + offset],
  // tailwindColors.pink[400 + offset],
];

// export const gray = tailwindColors.slate[300];
export const gray = "#D1D9E2";
export const neutral = "#eee";
