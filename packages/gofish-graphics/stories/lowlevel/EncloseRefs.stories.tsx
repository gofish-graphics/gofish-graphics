...
import { spreadX, rect, layer, enclose } from "../../src/lib";
...
export const EncloseRefs: StoryObj = {
  render: () => {
    ...
    layer([
      ...
      // A relate clause over the three named rects above: the hull must wrap
      // all three (spread apart by spreadX) plus padding — not collapse to
      // one rect's size at the origin.
      .relate((names) => [
        enclose({ padding: 6 }, [names["1"], names["2"], names["3"]]),
      ])
      .render(container, {});
    return container;
  },
