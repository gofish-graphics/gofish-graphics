...
| `anchor`      | `"edge" \| "start" \| "middle" \| "end" \| "baseline"` | `"edge"`     | Whether `spacing` is measured between facing edges (`"edge"`), or as a fixed pitch between a chosen anchor point on each child: `anchor[i+1] = anchor[i] + spacing`                                                                                                                                            |
